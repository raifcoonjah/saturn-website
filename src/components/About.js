      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div className="flex justify-center">
            <a
              href="https://github.com/raifcoonjah/Saturn-startpage/releases/latest"
            ...
            <a
              href="https://github.com/raifcoonjah/Saturn-startpage/releases/latest"
              className="py-2.5 px-5 mr-4 mb-4 text-white bg-gray-700 hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900"
            >
              Get for Chrome (.zip)
            </a>
            <a
